...
2. Создать директорию, переместить файл туда.
    ...
    * mv "Друзья человека.txt" /home/mv/Питомник
    ...
    ![Задание 1 и 2](/Screenshots/Task1-2.cat.mkdir.png)
...
4. Установить и удалить deb-пакет с помощью dpkg.
    ...
    * sudo dpkg -r mc
    ...
    ![Задание 4](/Screenshots/Task4.1.dpkg.png)
    ![Задание 4](/Screenshots/Task4.2.dpkg.png)
    ![Задание 4](/Screenshots/Task4.3.dpkg.png)

5. Выложить историю команд в терминале ubuntu
![Задание 5](/Screenshots/Task5.2History.png)
